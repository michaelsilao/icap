...
$j(document).ready(function () {
   ...
   var slider1 = $j('#bxslider1').bxSlider({
        controls: true,
		pager: true,
useCSS: false,
        preloadImages: 'all',
...
//auto:true,
	...
	//alert("next-image");
    $j('#banner .bx-wrapper .bx-controls-direction a.bx-next').click(function () {
        //$j('#banner #innerbanner .bx-wrapper .bx-controls-direction a.bx-prev').trigger('click');
        //$j('#banner2 .bx-wrapper .bx-controls-direction a.bx-next').trigger('click');
		//alert("next");
	slider1.goToSlide(slider.getCurrentSlide());
	slider.stopAuto();
	slider1.stopAuto();
        return false;
    });
    ...
    $j('#banner .bx-wrapper .bx-controls-direction a.bx-prev').click(function () {
        //$j('#banner2 .bx-wrapper .bx-controls-direction a.bx-prev').trigger('click');
     //alert("prev");
	slider1.goToSlide(slider.getCurrentSlide());
	slider.stopAuto();
	slider1.stopAuto();
    ...
    $j('#banner .bx-default-pager .bx-pager-item a').click(function (e) {
        e.preventDefault();
        slider1.goToSlide($j(this).attr("data-slide-index"));
		slider.stopAuto();
		slider1.stopAuto();
		//alert($j(this).attr("data-slide-index"));
