...
(function ($j, document, window) {
    ...
    function makeSettings() {
        ...
        if (data == null) {
            settings = $j.extend({}, defaults);
            if (console && console.log) {
                console.log('Error: cboxElement missing settings object');
            }
        } else {
            settings = $j.extend({}, data);
        }
    ...
    publicMethod = $j.fn[colorbox] = $j[colorbox] = function (options, callback) {
        ...
        if (addBindings()) {
            ...
            $this.each(function () {
                $j.data(this, colorbox, $j.extend({}, $j.data(this, colorbox) || defaults, options));
            }).addClass(boxElement);
...
$j(document).ready(function () {
    ...
    //$j(".rad-caption").colorbox({inline:true, width:"640", height:"360", href:"#video-content"});
    $j(".rad-caption").on("click", function () {
											 
       // var t1 = $j(this).attr("href");
      //  var vId = t1.substring(1, t1.length);
      ...
      //  if (t1.indexOf("#") != "-1")
            $j(this).colorbox({
               ...
               width: "643",
                height: "363",
                href: "/site-services/external-video.aspx",
                onOpen: function () {
					
					
				//	$j("#external-video-code").colorbox({inline:true});
				//$j("#external-video-code").css('display','block');
				
					
					
                    //$j("#video-content").html("<div class='inv_playerContainer' id='inv_playerContainer1' ></div>");
					
					/*$j("#inv_playerContainer1").embedCode({playerType:"singleplayer",videoId:vId,overlayPlay:true,autoPlay:false,width:640,
height:360, integrationMethod:"lightbox"});*/
...
//height:360
                ...
                onClosed: function () {
					//$j("#external-video-code").css('display','none');
              //   $j("#external-video-code").empty();
                    //$j("#inv_playerContainer1").remove();
                }
            });

		 $j('#slides2 .iframe').css("visibility", "hidden");
...
$j("#cboxOverlay,#cboxClose").click(function () {
    //alert("close");
    $j('#slides2 .iframe').css("visibility", "visible");
...
$j("a#iframeLink").click(function () {
    $j(this).colorbox({
        width: "90%",
        height: "auto",
        inline: true
    });
    //$j("a#mapLink").colorbox({onComplete:function(){ mapPop(); }});
